...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = f"postgresql://neondb_owner:{os.getenv('NEONDB_PASSWORD')}@ep-orange-mode-a13k4k1w-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require"  # Change to PostgreSQL if needed
