...
from app.api.v1.endpoints import user_routes, player_routes, auth_routes, test_routes, profile_routes, subject_routes, study_session_routes
...
async def lifespan(app: FastAPI):
    print("Potek na hakdog! Starting up cramquest...")
